...
export default function Home() {
  return (
    <Layout>
      ...
      <Container>
        <p>Pour plus d’informations, vous pouvez contactez-nous mais <strong>nous n’avons pas accès à vos informations, demandes et dossiers</strong> : <a href="mailto:contact@mes-aides.gouv.fr?subject=Demande  d’informations">contact@mes-aides.gouv.fr</a></p>
      </Container>
    </Layout>
  )
}
